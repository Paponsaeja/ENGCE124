...
void DispData(int Data[],int out) //Out is point of Outputted Numberbackward
{
    int i;
    for(i=1;i<=N;i++)
    {
...
void AdjustTree(int LastNode)
{
    ...
    printf("---------------------------------------------------AdjustTree FinishedN=%d \n",LastNode);
}

void CreateHeapTree(void) // Create form Data1 into Data2
{
    int i,j,k,father;
    bool result;
    //Craete Heap Tree
