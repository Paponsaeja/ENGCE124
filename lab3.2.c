/*    Program create INSERT/DELETE function of Circular Queue and use its by...
...
//-----------------------------------------------------------------------------------------
int    deleteCQ(void) //DELETE Function
{
    int   y;
    if (F == 0)
    {
...
//-----------------------------------------------------------------------------------------
int    DataInQueue(void) // Calculate Data waiting in queue
{
    int   y=0;
...
//-----------------------------------------------------------------------------------------
void ShowAllQueue(void) //Display Function
{
